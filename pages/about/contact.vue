...
<template>
  <MainLayout>
    <div class="sm:p-10 my-auto">
      <section
        class="mx-auto max-w-screen-xl md:rounded-md md:border md:shadow-lg"
      >
        <div class="grid grid-cols-4 text-gray-800 lg:grid-cols-3">
          <div
            class="col-span-4 bg-gray-800 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1"
          >
            <h2 class="mb-8 text-2xl font-black">Contact me</h2>
            <ul>
              <li class="mb-6 flex items-start text-left">
                <svg
                  class="shrink-0 mr-6 text-2xl text-gray-200"
                ...
                <div>
                  <a
                    class="cursor-pointer font-serif text-base md:text-lg text-gray-100"
                    href="#"
                    >info@brandplanet.rw</a
                  >
                  <span class="block text-xs uppercase text-gray-100">email</span>
                </div>
              </li>
              ...
              <li class="my-6 flex items-center text-left">
                ...
                <div>
                  <p class="font-serif text-base md:text-lg text-gray-50">Brand Planet</p>
                  <span class="block text-xs uppercase text-gray-50">LinkedIn</span>
                </div>
              </li>
            </ul>
          </div>
          <div
            class="order-first col-span-4 max-w-screen-md px-8 py-10 md:order-last md:col-span-2 md:px-10 md:py-12"
          >
